    ...
    def obtener_cuenta_cliente(self, numero_cuenta):
        for cliente in self.clientes:
            if cliente.numero_cuenta == numero_cuenta:
                # Imaginemos que cada cliente tiene solo una cuenta
...
cliente1 = Cliente("Altagracia Lora", "Santa Cruz de Mao", "0123456789", 40500, "01234")
cliente2 = Cliente("José Andujar", "Santiago de los Caballeros", "9876543210", 60000, "56789")
